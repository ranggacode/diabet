...
def load_data():
    ...
    url ="https://raw.githubusercontent.com/ranggacode/diabet/refs/heads/main/pima_diabetes.csv"
...
def main():
    ...
    insulin = st.sidebar.number_input("Insulin", min_value=0, max_value=1000, value=50)
    bmi = st.sidebar.number_input("BMI", min_value=0.0, max_value=50.0, value=25.0)
    diabetes_pedigree = st.sidebar.number_input("Diabetes Pedigree", min_value=0.0, max_value=2.0, value=0.5)
